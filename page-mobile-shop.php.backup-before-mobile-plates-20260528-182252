...
if ($shop_bg) {
    echo '<style id="dkg-mobile-shop-layout-force">
        ...
        /*
         * WooCommerce adds clearfix pseudo-elements to product grids.
         * In CSS grid, those can appear as ghost grid items/gaps.
         */
        .dkg-mobile-shop-main ul.products::before,
        .dkg-mobile-shop-main ul.products::after {
            content: none !important;
            display: none !important;
        }

        .dkg-mobile-shop-main ul.products li.product.first,
        .dkg-mobile-shop-main ul.products li.product.last {
